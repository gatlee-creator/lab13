...
public:
    ...
    //Function to reverse the stack order using recursion.
    //Precondition: The stack exists, is not empty, and is passed
    //              another stack list with those conditions.
    //Postcondition: The stack being passed will copy the values
    //               from the orignal in reverse order.
